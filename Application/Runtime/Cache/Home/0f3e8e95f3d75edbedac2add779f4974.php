                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover table-striped" style="width: 100%">
                                    <a href="course.html"><button type="button" class="btn btn-lg btn-primary">课程查询</button></a>
                                    <a href="courseMark.html"><button type="button" class="btn btn-lg btn-success">成绩统计</button></a>
                                </table>
                            </div>
                        </div>
                    </div>
