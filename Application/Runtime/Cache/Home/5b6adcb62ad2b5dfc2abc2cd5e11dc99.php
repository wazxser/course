                ...
                <div style="margin: 60px 30px 30px 30px">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-money fa-fw"></i><?php echo ($type); ?></h3>
                        </div>
                            ...
                            <form role="form" action="index" method="post">
                                <div class="row">
                                    <div class="form-group col-lg-12">
                                        <label><?php echo ($typeid); ?> :</label>
                                        <input style="width:410px;" type="text" name="logid" class="form-control">
                                    </div>
                                    <br />
                                    <div class="form-group col-lg-12">
                                        <label>密码 :</label>
                                    ...
                                    <div class="form-group col-lg-12">
                                        <label>验证码 :</label>
                                        <img alt="验证码" src="<?php echo U('Login/verify');?>" style="width: 100; height: 50px"
                                             onclick = "src='<?php echo U('Login/verify');?>'" title="点击刷新"/>
                                        <input style="width:410px;" type="text" name="yanzhengma" class="form-control">
                                    </div>
                                    <br />
                                    <div class="form-group col-lg-12">
