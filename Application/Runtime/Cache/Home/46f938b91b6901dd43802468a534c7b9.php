                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover table-striped" style="width: 100%">
                                    <a href="studentinfo.html"><button type="button" class="btn btn-lg btn-primary">学生信息</button></a>
                                    <a href="courseinfo.html"><button type="button" class="btn btn-lg btn-success">课程信息</button></a>
                                    <a href="selectinfo.html"><button type="button" class="btn btn-lg btn-danger">选课信息</button></a>
                                </table>
                            </div>
                        </div>
                    </div>
