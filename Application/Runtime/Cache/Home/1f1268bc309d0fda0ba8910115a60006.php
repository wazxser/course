                ...
                <div style="margin: 60px 30px 30px 30px">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-money fa-fw"></i>修改选课信息</h3>
                        </div>
                        <div class="panel-body">
                            ...
                            <form role="form" action="selectModify?id=<?php echo ($id); ?>" method="post">
                                <div class="row">
                                    <!--<div class="form-group col-lg-12">-->
                                        <!--<label>选课编号 :<h3><?php echo ($id); ?></h3></label>-->
                                    <!--</div>-->
                                    <!--<br />-->
                                    <div class="form-group col-lg-12">
                                        <label>学生编号 :</label>
                                        <input style="width:410px;" type="text" name="sid"
                                               value = "<?php echo ($sid); ?>" onfocus="this.value = '';"
                                               onblur="if (this.value == '') {this.value = '<?php echo ($sid); ?>';}"
                                               class="form-control">
                                    </div>
                                    <br />
                                    <div class="form-group col-lg-12">
                                    ...
                                    <div class="form-group col-lg-12">
                                        <label>时间 :</label>
                                        <input style="width:410px;" type="text" name="year"
                                               value = "<?php echo ($year); ?>" onfocus="this.value = '';"
                                               onblur="if (this.value == '') {this.value = '<?php echo ($year); ?>';}"
                                               class="form-control">
                                    </div>
                                    <br />
                                    <div class="form-group col-lg-12">
                                        <label>成绩 :</label>
                                        <input style="width:410px;" type="text" name="mark"
                                               value = "<?php echo ($mark); ?>" onfocus="this.value = '';"
                                               onblur="if (this.value == '') {this.value = '<?php echo ($mark); ?>';}"
                                               class="form-control">
                                    </div>
                                    <br />
