                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped" style="width: 100%">
                                <a href="info.html"><button type="button" class="btn btn-lg btn-primary">个人信息 </button></a>
                                <a href="select.html"><button type="button" class="btn btn-lg btn-warning">学生选课</button></a>
                                <a href="mark.html"><button type="button" class="btn btn-lg btn-success">成绩查询</button></a>
                                <a href="course.html"><button type="button" class="btn btn-lg btn-danger">课程查询</button></a>
                                <a href="pwd.html"><button type="button" class="btn btn-lg btn-warning">修改密码</button></a>
                            </table>
                        </div>
                    </div>
                </div>
