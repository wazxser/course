...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo U('Teacher/t2');?>">返回</a>        </div>
        <!-- /.navbar-collapse -->
    </nav>
                ...
                <div style="margin: 60px 30px 30px 30px">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form role="form" action="studentMark" method="post">
                                <div class="row">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div style="margin: 60px 30px 30px 30px">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-money fa-fw"></i>加权</h3>
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover table-striped" style="width: 100%">
                                    <h3><?php echo ($sname); ?>的加权成绩为：<?php echo ($studentAve); ?></h3>
                                </table>
                            </div>
                        </div>
                    </div>
