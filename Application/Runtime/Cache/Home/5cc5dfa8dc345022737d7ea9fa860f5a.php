                ...
                <div style="margin: 60px 30px 30px 30px">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-money fa-fw"></i>修改学生信息</h3>
                        </div>
                        <div class="panel-body">
                            ...
                            <form role="form" action="studentModify?sid=<?php echo ($sid); ?>" method="post">
                                <div class="row">
                                    <div class="form-group col-lg-12">
                                        <label>学生编号 :<h3><?php echo ($sid); ?></h3></label>
                                    </div>
                                    <br />
                                    <div class="form-group col-lg-12">
                                        <label>学生姓名 :</label>
                                        <input style="width:410px;" type="text" name="sname"
                                               value = "<?php echo ($sname); ?>" onfocus="this.value = '';"
                                               onblur="if (this.value == '') {this.value = '<?php echo ($sname); ?>';}"
                                               class="form-control">
                                    </div>
                                    <br />
                                    <div class="form-group col-lg-12">
                                        <label>入学年龄 :</label>
                                        <input style="width:410px;" type="text" name="inage"
                                               value = "<?php echo ($inage); ?>" onfocus="this.value = '';"
                                               onblur="if (this.value == '') {this.value = '<?php echo ($inage); ?>';}"
                                               class="form-control">
                                    </div>
                                    <br />
                                    <div class="form-group col-lg-12">
                                        <label>入学年份 :</label>
                                        <input style="width:410px;" type="text" name="inyear"
                                               value = "<?php echo ($inyear); ?>" onfocus="this.value = '';"
                                               onblur="if (this.value == '') {this.value = '<?php echo ($inyear); ?>';}"
                                               class="form-control">
                                    </div>
                                    <br />
                                    <div class="form-group col-lg-12">
                                        <label>班级 :</label>
                                        <input style="width:410px;" type="text" name="class"
                                               value = "<?php echo ($class); ?>" onfocus="this.value = '';"
                                               onblur="if (this.value == '') {this.value = '<?php echo ($class); ?>';}"
                                               class="form-control">
                                    </div>
                                    <br />
