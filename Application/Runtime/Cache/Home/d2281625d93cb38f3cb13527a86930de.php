                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover table-striped" style="width: 100%">
                                    <form action="studentinfo" method="post">
                                            <input type="text" style="width:30%" name="key" class="form-control" placeholder="学号，姓名">
                                    </form>
                                    <br />
                                    <thead>
                                    <tr>
                                    ...
                                    <?php if(is_array($student)): $i = 0; $__LIST__ = $student;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$student): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td><?php echo ($student["class"]); ?>班</td>
                                            <td><a href="<?php echo U('Home/Teacher/stddelete');?>?sid=<?php echo ($student["sid"]); ?>">删除</a></td>
                                            <td><a href="<?php echo U('Home/Teacher/studentModify');?>?sid=<?php echo ($student["sid"]); ?>">修改</a></td>
                                        </tr><?php endforeach; endif; else: echo "" ;endif; ?>

                                    </tbody>
                                </table>
                                <a href="studentAdd.html"><button type="button" class="btn btn-lg btn-default">Add</button></a>
