...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo U('Teacher/t1');?>">返回</a>
        </div>
        <!-- /.navbar-collapse -->
    </nav>
                ...
                <div style="margin: 60px 30px 30px 30px">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-money fa-fw"></i><?php echo ($cname); ?></h3>
                        </div>
                        <div class="panel-body">
                            <!--<form role="form" action="courseMark" method="post">-->
                                <!--<div class="row">-->
                                    <!--<div class="form-group col-lg-12">-->
                                        <!--<label>年级 :</label>-->
                                        <!--<input style="width:410px;" type="password" name="grade" class="form-control">-->
                                    <!--</div>-->
                                    <!--<br />-->

                                    <!--&lt;!&ndash;<div class="form-group col-lg-12">&ndash;&gt;-->
                                        <!--&lt;!&ndash;<input type="hidden" name="save" value="contact">&ndash;&gt;-->
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div style="margin: 60px 30px 30px 30px">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-money fa-fw"></i>成绩分布</h3>
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover table-striped" style="width: 100%">
