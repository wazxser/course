                ...
                <div style="margin: 60px 30px 30px 30px">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-money fa-fw"></i>添加选课信息</h3>
                        </div>
                        <div class="panel-body">
                            ...
                            <form role="form" action="selectAdd" method="post">
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-12">
                                        <label>时间 :</label>
                                        <input style="width:410px;" type="text" name="year" class="form-control">
                                    </div>
                                    <br />
                                    <div class="form-group col-lg-12">
                                        <label>成绩 :</label>
                                        <input style="width:410px;" type="text" name="mark" class="form-control">
                                    </div>
                                    <br />
